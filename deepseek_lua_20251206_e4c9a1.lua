...
-- */  Aimbot Section  /* --
do
    local AimbotTab = OtherSection:Tab({
        Title = "Aimbot",
        Icon = "target",
    })
    ...
    local function updateAimbot()
        ...
        if aimbotEnabled and localPlayer.Character then
            aimbotConnection = RunService.RenderStepped:Connect(function()
                ...
                if currentTime - lastAimTime > 0.033 then
    ...
    -- Add toggle to WindUI
    AimbotTab:Toggle({
        Title = "Aimbot",
        Desc = "Enable/Disable auto aim feature",
        Callback = function(state)
            aimbotEnabled = state
            updateAimbot()
            if state then
    ...
    AimbotTab:Slider({
        Title = "Aimbot Range",
        Desc = "Maximum distance for aimbot to work",
        Value = {
            Min = 10,
            Max = 200,
            Default = 100,
